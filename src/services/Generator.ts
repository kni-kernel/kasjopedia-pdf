 ...
 * @param planData
 */
export const generateSemesterPlan = async (planData: SemesterPlan): Promise<Buffer> => {
  try {
    ...
    await page.goto(`http://localhost:${config.get("app.koaPort")}/?data=${base64encodedData}`, {
